import { Project, Experience, SkillCategory, BlogPost, GameSkill, Achievement, Principle, NextSkillOption, ThemeConfig, ImpactMarker, MentalFramework, InterviewQuestion } from './types';
import Eagle from './imgs/Animals/Eagle.png';
import Lion from './imgs/Animals/Lion.png';
import Wolf from './imgs/Animals/Wolf.png';
import Ant from './imgs/Animals/Ant.png';
import Cheetah from './imgs/Animals/Cheetah.png';
import AeronicX from './imgs/Projects/AeronicX.png';
import AURORA from './imgs/Projects/AURORA.png';
import FounderPilot from './imgs/Projects/FounderPilot.png';
import RCBFanPortal from './imgs/Projects/RCB FanPortal.png';
import EcoGraphEngine from './imgs/Projects/EcoGraph Engine.png';
import ThinkLT from "./imgs/Principles/ThinkLT.png";
import SystemOS from "./imgs/Principles/SystemOS.png";
import DisciplineOM from "./imgs/Principles/DisciplineOM.png";
import BuiltFI from "./imgs/Principles/BuiltFI.png";
import LearnR from "./imgs/Principles/LearnR.png";
import MyPhoto from "./imgs/MyPhoto/Myphoto.jpeg";
...
export const MENTAL_FRAMEWORKS: MentalFramework[] = [
  {
    id: 'eagle',
  ...
  },
  {
    ...
    detailedContent: 'As Convenor of the Math Club , NSS Convenor and CEO of the CESE Program, I foster "Wolf Pack" dynamics. I lead by coordinating diverse talents to achieve complex goals, whether it is organizing national-level technical events or leading community impact workshops.'
  },
  {
    id: 'ant',
    ...
    detailedContent: 'Demonstrated through the development of AtomoraCQ. I believe massive impact is the result of compounding small, disciplined efforts. I apply this to building robust codebases where every modular component contributes to a larger, unbreakable system.'
  },
  {
    id: 'cheetah',
...
export const GAME_ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    requirement: "Systems Thinking Level 3",
  ...
  },
  {
    ...
    requirement: "Problem Solving Level 6",
...
export const SKILLS: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Fast Calculations", level: 98 },
...
export const EXPERIENCES: Experience[] = [
  {
    ...
    skills: ["React", "Virtual Intern", "Problem Solving", "Full Stack Web Dev"]
  },
  {
    company: "Vezos Partners",
    role: "Chief Executive Officer (CEO)",
    period: "Apr 2026 - Present",
    description: [
      "A subscription-based platform that acts as a bridge between agencies and skilled freelancers, providing agencies with reliable creative and marketing services (design, content, video editing, etc.) at a fixed monthly cost, helping them increase profit margins, reduce operational effort, and scale efficiently.",
      "Leading business strategy, partnerships, and growth by onboarding agencies, building a strong freelancer network, ensuring service quality, and driving scalable revenue through a sustainable subscription model."
    ],
    skills: ["Revenue Growth Strategy", "Strategic Leadership", "Client Acquisition", "Negotiation & Deal Closing"]
  },
  {
    company: "Math Club",
    role: "Convenor",
...
export const PROJECTS: Project[] = [
  {
    ...
    techStack: ["TypeScript", "Next.js", "VQE", "ML", "QOAO"],
    ...
    githubUrl: "https://github.com/coderhash-sketch/AeronicX",
    date: "Jan 2026"
  },
  {
    id: "founderpilotai",
